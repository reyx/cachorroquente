...
<p>
    <strong>
        <span class="label label-important">Prêmio principal</span> <u>O melhor Cachorro Quente de Osasco</u>
    </strong>
</p>
<ul>
...
<p>
    <strong>
        <span class="label label-important">Prêmio extra</span> <u>O maior comedor de Cachorros Quentes de Osasco</u>
    </strong>
</p>
<ul>
...
<p class="alert alert-warning">
    A inscrição será <strong>gratuita</strong> e aberta ao público, na internet.<br />
    Serão sorteados <strong>15 participantes</strong>, pouco antes do início da competição.
</p>

<p><a href="/sobre/localizacao/">Saiba mais...</a></p>
